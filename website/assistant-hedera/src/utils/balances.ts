...
export const ZERO_ADDRESS = '0.0.0' as Address;
...
export async function getContractBalance(userAddress: Address, tokenAddress: Address): Promise<ContractBalance | null> {
  try {
    ...
    const checkAddress = tokenAddress === ZERO_ADDRESS ? wAddress : tokenAddress;
    ...
    const displayAddress = tokenAddress === ZERO_ADDRESS ? ZERO_ADDRESS : tokenAddress;
