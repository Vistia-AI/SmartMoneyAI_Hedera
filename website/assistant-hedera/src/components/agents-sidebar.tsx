...
export function AgentsSidebar({ onClose }: AgentsSidebarProps) {
      ...
      return [
        {
          ...
          description: "Help swapping tokens",
        },
        {
          id: "smart-money",
          name: "Smart Money",
  ...
  useEffect(() => {
    if (
      ...
      router.push(`/app/chat/${agents[0].id}`);
    }
  }, [currentAgentId, agents, router, pathname]);
