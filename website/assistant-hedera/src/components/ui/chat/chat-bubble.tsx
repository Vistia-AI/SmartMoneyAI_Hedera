  ...
  "relative flex flex-col gap-2 text-lg sm:text-sm leading-[1.6] sm:leading-relaxed tracking-normal transition-all duration-200 w-fit",
  {
    variants: {
      variant: {
        ...
        received:
          "bg-gradient-to-br from-[#27272A] via-[#1f1f1f] to-[#171717] shadow-md border border-white/[0.08] rounded-2xl rounded-tl-sm hover:shadow-white/[0.02]",
      },
    },
    defaultVariants: {
      variant: "received",
...
export function ChatBubbleMessage({
  ...
  if (isLoading) {
    return (
      <div className="flex items-center gap-3 text-muted-foreground animate-pulse font-medium tracking-tight" {...props}>
