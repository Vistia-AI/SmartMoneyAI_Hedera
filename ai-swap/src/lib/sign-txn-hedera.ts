...
export async function swapTokensWithMetaMask(
  ...
  console.log('Clients and wallet address:', { walletClient, walletAddress, publicClient })
  ...
  console.log('Decimals:', { fromTokenDecimal, toTokenDecimal })
  ...
  console.log('Swap transaction receipt:', txnReceipt)
